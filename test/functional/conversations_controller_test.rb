...
class ConversationsControllerTest < ActionController::TestCase
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post :create, conversation: { buyer_id: @conversation.buyer_id, item_id: @conversation.item_id }
    end
  ...
  test "should update conversation" do
    put :update, id: @conversation, conversation: { buyer_id: @conversation.buyer_id, item_id: @conversation.item_id }
    assert_redirected_to conversation_path(assigns(:conversation))
  end
